...
require (
	...
	github.com/containers/conmon-rs v0.6.2-0.20240304140131-e74f9de3e8f8
...
replace github.com/containers/common => github.com/containers/common v0.57.1-0.20240304165751-a0d555c70d52
